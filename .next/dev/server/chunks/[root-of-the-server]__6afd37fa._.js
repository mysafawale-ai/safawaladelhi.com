...
function sitemap() {
    ...
    const mainPagesSitemap = mainPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
    ...
    const locationPagesSitemap = locationPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'weekly',
            priority: 0.9
    ...
    const colorPagesSitemap = colorPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
    ...
    const fabricStylePagesSitemap = fabricStylePages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.8
    ...
    const regionalPagesSitemap = regionalPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.8
    ...
    const ceremonyPagesSitemap = ceremonyPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.8
    ...
    const festivalPagesSitemap = festivalPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.75
    ...
    const familyPagesSitemap = familyPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.8
    ...
    const internationalPagesSitemap = internationalPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.8
    ...
    const matchingPagesSitemap = matchingPages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.75
    ...
    const alternativePagesSitemap = alternativePages.map((page)=>({
            url: `${baseUrl}/${page}`,
            lastModified: currentDate,
            changeFrequency: 'monthly',
            priority: 0.7
