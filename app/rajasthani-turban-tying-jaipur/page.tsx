...
const jaiaurAreas = [
  ...
  "Kalyan Vihar", "Vidhyadhar Nagar", "Shyam Nagar", "Pal Road", "Bapu Nagar",
]

export const metadata = {
  title: "Rajasthani Turban Tying Jaipur | Authentic Traditional Service | Safawala",
  description:
    "Authentic Rajasthani turban tying service in Jaipur. Expert traditional turban styling maintaining cultural heritage. Safawala provides professional turban service.",
}

export default function RajasthaniTurbanTying() {
  const pageData = {
    title: "Rajasthani Turban Tying Jaipur",
    shortDescription:
      "Experience authentic Rajasthani turban tying traditions with Safawala. Our experts specialize in traditional Rajasthani turban styles that honor your cultural heritage while adding royal elegance to your special occasion.",
    description: "Professional Rajasthani turban tying service in Jaipur.",
    mainImage: "/12-4.webp",
    videos: ["/video-4.mp4", "/video-5.mp4"],
    galleryImages: ["/12-5.webp", "/13-3.webp", "/14-3.webp", "/14-4.webp", "/15-2.webp"],
    areas: jaiaurAreas,
    keyFeatures: [
      "Authentic Rajasthani turban traditions",
      "Expert in classic royal turban styles",
      "Perfect cultural representation",
      "Timeless traditional designs",
      "Professional execution of ancient techniques",
      "Comfortable wear throughout celebrations",
      "Photo-perfect aesthetic appeal",
      "Customized to your personal style",
    ],
    seoKeywords: [
      "rajasthani turban tying jaipur",
      "authentic turban service",
      "traditional rajasthani turban",
      "rajasthani wedding turban",
    ],
    content: `
...
<p><strong>Call:</strong> +91-9725295692 | <strong>Regional Specialist Available</strong> | <strong>WhatsApp Available</strong> | <strong>Free Consultation</strong></p>
    ...
    faqs: [
      {
        question: "What makes Safawala's Rajasthani turban service unique?",
        answer:
          "Our specialists have deep knowledge of authentic Rajasthani turban traditions and use time-tested techniques to create perfect turbans.",
      },
      {
        question: "Can you create turbans from different Rajasthani regions?",
        answer: "Yes, we can create authentic turbans from Jaipur, Jodhpur, Udaipur, and other Rajasthani regions.",
      },
      {
        question: "Do you provide guidance on matching attire?",
        answer:
          "Absolutely. We guide you on coordinating your turban with sherwani, sehra, and other traditional wear.",
      },
    ],
  }
